		  ...
		  <div className = 'aboutWrapper'>
		    ...
		    { !this.props.isAuthenticated && <div>
				...
				{ this.props.isAuthenticated && <div>
					...
					<h3 className = 'credits'><a target = "_blank" href = "#">View the source on GitHub</a></h3>
					<h3 className = 'credits'>This app was created with React and Redux and is a <a target = "_blank" href = "#">project for Free Code Camp</a>.</h3>
					</div> }
